...
<template>
  <div class="headers-analyzer-view">
    <div class="flex justify-between items-center mb-6">
      <h1 class="text-2xl font-bold">HTTP Headers Analyzer</h1>
    </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
      ...
      <div class="lg:col-span-2">
        ...
        <div v-if="showAnalysisResults" class="bg-white rounded-lg shadow p-4 mb-6">
          <div class="flex items-center justify-between mb-4">
            <h2 class="text-lg font-medium">Analysis Results</h2>
            <div class="flex items-center">
              <div class="mr-2 text-sm font-medium">Security Score:</div>
      ...
      <div class="lg:col-span-1">
        <div class="bg-white rounded-lg shadow p-4 mb-6">
          <h2 class="text-lg font-medium mb-4">Common {{ headerType === 'request' ? 'Request' : 'Response' }} Headers</h2>

          <div class="space-y-4">
            <div v-for="header in headerSections" :key="header.name" class="border-b border-gray-200 pb-4 last:border-b-0 last:pb-0">
              <div class="flex justify-between items-start">
                <h3 class="text-md font-medium text-gray-900">{{ header.name }}</h3>
                <button
              ...
              <p class="text-sm text-gray-600 mb-1">{{ header.description }}</p>
        ...
        <div class="bg-white rounded-lg shadow p-4">
          <h2 class="text-lg font-medium mb-2">Tips</h2>

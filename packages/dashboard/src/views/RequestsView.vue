          ...
          <div>
            ...
            <div v-if="activeRequestTab === 'body'" class="request-tab-panel">
              <div class="mb-2 flex justify-between items-center">
                <h3 class="text-sm font-medium text-gray-700">Request Body</h3>
                <select
                  v-model="bodyType"
              ...
              <div class="border border-gray-200 rounded-md overflow-hidden">
                ...
                <div v-else class="max-h-96 overflow-y-auto">
                  ...
                  >
                    ...
                    <div class="text-sm text-gray-500 font-mono break-all">{{ value }}</div>
                  </div>
                </div>
              </div>
            </div>
...
const resolvedUrl = computed(() => {
  let processedUrl = requestService.processEnvironmentVariables(url.value)

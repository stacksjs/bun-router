          ...
          <div class="grid grid-cols-2 gap-4">
            ...
            <div>
              ...
              <div class="mb-2">
                ...
                <div class="text-sm font-mono bg-gray-50 p-2 rounded break-all">{{ item.url }}</div>
              </div>

              <div class="mb-2">
                <div class="text-xs font-medium text-gray-500 mb-1">Headers</div>
              ...
              <div v-if="item.body" class="mb-2">
                <div class="text-xs font-medium text-gray-500 mb-1">Body</div>
            ...
            <div>
              ...
              <div v-if="item.responseTime" class="mb-2">
                <div class="text-xs font-medium text-gray-500 mb-1">Time</div>
                <div class="text-sm font-mono bg-gray-50 p-2 rounded">{{ item.responseTime }}ms</div>
              </div>

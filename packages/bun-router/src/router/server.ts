...
export function registerServerHandling(RouterClass: typeof Router): void {
  // Add server handling methods to Router.prototype
  RouterClass.prototype.serve = async function (options: ServerOptions = {}): Promise<Server> {
  ...
  RouterClass.prototype.reload = async function (): Promise<void> {
  ...
  RouterClass.prototype.handleRequest = async function (req: Request): Promise<Response> {
    try {
  ...
  RouterClass.prototype.enhanceRequest = function (req: Request, params: Record<string, string> = {}): EnhancedRequest {
  ...
  RouterClass.prototype.applyModifiedCookies = function (response: Response, req: EnhancedRequest): Response {
  ...
  RouterClass.prototype.serializeCookie = function (name: string, value: string, options: any = {}): string {

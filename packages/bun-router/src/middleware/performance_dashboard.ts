    ...
    <div class='container'>
        ...
        <div class='card'>
            ...
            <div class='metric'>
                ...
                <span class=': : ? ? ""} "critical" "warning" > > ${data.metrics.current.errorRate 0.05 0.1 data.metrics.current.errorRate metric-value'>${Math.round(data.metrics.current.errorRate * 100)}%</span>
            </div>
        </div>
        `
          : ''}
